(function() {
  ...
  function detailDetails() {
    return {
      templateUrl: 'ticket/views/details.html',
      restrict: 'E'
    };
  }
  ...
  function detailSidebar() {
    return {
      templateUrl: 'ticket/views/sidebar.html',
      restrict: 'E'
    };
  }
  ...
  function detailAlternative() {
    return {
      templateUrl: 'ticket/views/alternative.html',
      restrict: 'E'
    };
  }
  ...
  function detailRelated($timeout, angularGridInstance) {
    return {
      templateUrl: 'ticket/views/related-product.html',
      restrict: 'E',
  ...
  function detailWhere() {
    return {
      templateUrl: 'ticket/views/where-can-i-use.html',
      restrict: 'E'
    };
  }
  ...
  function operators() {
    return {
      templateUrl: 'ticket/views/operator.html',
      restrict: 'E'
    };
  }
